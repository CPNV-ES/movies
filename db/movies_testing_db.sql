...
CREATE TABLE IF NOT EXISTS `movies`.`files` (
  ...
  `FileTitle` VARCHAR(200) NOT NULL COMMENT '',
...
-- Table `movies`.`tokens`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `movies`.`tokens` ;

CREATE TABLE IF NOT EXISTS `movies`.`tokens` (
  `idTokens` INT NOT NULL AUTO_INCREMENT COMMENT '',
  `Path` VARCHAR(120) NOT NULL COMMENT '',
  `Step` VARCHAR(120) NOT NULL COMMENT '',
  `Item` INT NULL COMMENT '',
  `ItemPast` INT NULL COMMENT '',
  PRIMARY KEY (`idTokens`)  COMMENT '',
  UNIQUE INDEX `idTokens_UNIQUE` (`idTokens` ASC)  COMMENT '',
